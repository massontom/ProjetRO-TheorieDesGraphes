	...
	switch(choix)
	{
		case 1 :{
          ...
          System.out.println("quitter : tapez 9");
					...
					switch(secondChoice){
						case 1 : System.out.println("Par communes et mois"); break; //ajoutez les requetes correspondantes
						case 2 : System.out.println("Par communes et jour"); break;
            case 3 : System.out.println("Par communes et heure"); break;
            case 4 : System.out.println("Par communes et minute"); break;
        ...
        switch(thirdChoice){
            case 1 : System.out.println("Par communes et mois"); break; //requetes à ajouter ici aussi
            case 2 : System.out.println("Par communes et jour"); break;
            case 3 : System.out.println("Par communes et heure"); break;
            case 4 : System.out.println("Par communes et minute"); break;
            case 9 : arret = true; break;
